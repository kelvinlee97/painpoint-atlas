                    ...
                    "content": [
                        {
                            ...
                            "text": (
                                ...
                                "label 用简短、具体的日常语言描述用户遇到的事，避免抽象分类名；不可编造经历。summary 最多两句，先说场景，再说代价。不要写空泛的‘提升体验’，validation_action 必须是独立开发者可在一周内执行的低成本验证，不得假设能访问竞品内部日志、埋点或修改竞品；优先访谈、公开流程复现或可点击原型测试。"
                                + (
