...
class WorkflowSecurityTests(unittest.TestCase):
    def test_workflow_scopes_secret_and_pins_actions(self):
        ...
        self.assertNotIn("github.event_name != 'push'", persist_job)
        self.assertIn(
            '--subject "chore: refresh painpoint atlas [skip ci]"', persist_job
        )
        self.assertNotIn("github.event_name != 'push'", refresh_job)
        self.assertNotIn("github.event_name != 'push'", deploy_job)
